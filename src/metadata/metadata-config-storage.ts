 ...
 */
export class MetadataConfigStorage {
  public readonly tables: TableMetadataArgs[] = [];
  public readonly trees: TreeMetadataArgs[] = [];
  public readonly entityRepositories: EntityRepositoryMetadataArgs[] = [];
  public readonly transactionEntityManagers: TransactionEntityMetadataArgs[] = [];
  public readonly transactionRepositories: TransactionRepositoryMetadataArgs[] = [];
  public readonly namingStrategies: NamingStrategyMetadataArgs[] = [];
  public readonly entitySubscribers: EntitySubscriberMetadataArgs[] = [];
  public readonly indices: IndexMetadataArgs[] = [];
  public readonly uniques: UniqueMetadataArgs[] = [];
  public readonly checks: CheckMetadataArgs[] = [];
  public readonly columns: ColumnMetadataArgs[] = [];
  public readonly generations: GeneratedMetadataArgs[] = [];
  public readonly inheritances: InheritanceMetadataArgs[] = [];
  public readonly discriminatorValues: DiscriminatorValueMetadataArgs[] = [];
  ...
  findGenerated(
    ...
    return this.generations.find(generated => {
      return (
        (target instanceof Array ? target.indexOf(generated.target) !== -1 : generated.target === target) &&
  ...
  filterTransactionEntityManagers(target: Function | string, propertyName: string): TransactionEntityMetadataArgs[] {
    return this.transactionEntityManagers.filter(transactionEm => {
      return (
        (target instanceof Array ? target.indexOf(transactionEm.target) !== -1 : transactionEm.target === target) &&
  ...
  filterSingleTableChildren(target: Function | string): TableMetadataArgs[] {
    return this.tables.filter(table => {
      return (
        table.target instanceof Function &&
   ...
   */
  protected filterByTargetAndWithoutDuplicateProperties<T extends { target: Function | string; propertyName: string }>(
    array: T[],
    target: (Function | string) | (Function | string)[]
  ): T[] {
    const newArray: T[] = [];
